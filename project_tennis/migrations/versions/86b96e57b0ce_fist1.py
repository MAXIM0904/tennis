...
Revision ID: 86b96e57b0ce
Revises: 
Create Date: 2022-11-21 16:11:44.561206
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('balls_id_seq'::regclass)"), autoincrement=True, nullable=False),
